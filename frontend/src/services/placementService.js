// [설명]
// 이 파일은 프론트엔드에서 백엔드의 가구 배치/추천 API를 호출하는 헬퍼 함수들을 제공합니다.
// 실제 가구 추천/배치 알고리즘은 백엔드(Python: furniture_choosing_algorithm.py, furniture_placement_algorithm.py)에서 실행됩니다.
// getAutoPlacement는 백엔드 API를 호출하고, getMockPlacement는 프론트엔드 단독 테스트용 임시 함수입니다.
