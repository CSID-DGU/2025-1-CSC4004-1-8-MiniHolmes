...
| 역할      | 이름   | 학번        | 세부역할      |
|:---------:|:------:|:-----------:|:---------:|
| Backend   | 박태선 | 2023110430  | 알고리즘(가구 배치) |
| Backend   | 김예원 | 2023112422  | 알고리즘(가구 추천), 제안서 발표 |
| Backend  | 박세진 | 2021111941  | 백엔드(가구 렌더링) 전반 및 배포 |
| Frontend  | 전혜원 | 2022113092  | 팀장, 기획, 프론트엔드 전반, 최종 발표 |
| Frontend  | 하지연 | 2021111950  | 프론트엔드(3D 도면 시각화, 도면 색상 변경) |
